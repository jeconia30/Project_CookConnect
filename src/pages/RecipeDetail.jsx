...
const RecipeDetail = () => {
  ...
  useEffect(() => {
    const fetchRecipe = async () => {
      try {
        ...
        // Update status interaksi berdasarkan respon API
        ...
        console.error("Fetch Detail Error:", error.response || error);
  ...
  if (isLoading || !recipe) {
    return <div style={{ textAlign: 'center', marginTop: '20px', flexGrow: 1 }}>Memuat Detail Resep...</div>;
  }
    ...
    <div className="loggedin-body">
      ...
      <div className="recipe-detail-header">
        ...
        <div className="post-header revised">
          <div className="profile-pic-small" style={{ backgroundImage: `url(${displayRecipe.avatar_url})` }}></div>
      ...
      <img src={displayRecipe.image_url || displayRecipe.image} alt={displayRecipe.title} className="recipe-hero-image"/>
      ...
      <div className="post-actions detail-page-actions">
        ...
        <a href="#comments-section" style={{ textDecoration: "none", color: "inherit" }}>
          <i className="far fa-comment"></i> {displayRecipe.comment_count || 0} Komentar
        </a>
        ...
        <button onClick={handleSave} className={isSaved ? "save-active" : ""}>
          ...
          <CommentsSection comments={dummyComments} commentCount={displayRecipe.comment_count} />
        </div>
      </main>
    </div>
  );
