        ...
        <div className="navbar">
          ...
          <nav>
            <ul className="nav-links">
              ...
              <li>
                <a href="#preview">Resep Unggulan</a>
              </li>
              <li>
...
const LandingPageFooter = () => {
  return (
    <footer>
      <p>
        &copy; 2025 CookConnect. Dikembangkan untuk Mata Kuliah Pemrograman Web.
      </p>
    </footer>
  );
};
    ...
    <div>
      ...
      <main className="main-content-wrapper">
        <section id="home" className="hero-section container">
          <div className="hero-text-content">
            ...
            <p className="subtitle">
              Temukan inspirasi memasak baru dan jalin koneksi dengan para
              pecinta kuliner dari seluruh dunia, dalam platform sosial media
              resep yang modern.
            </p>
            <Link to="/login" className="cta-button hero-cta-button">
              Coba Sekarang!
            </Link>
          </div>
          <div
            ...
            style={{
              backgroundImage: `url(${heroBgPlaceholder})`,
          ...
          <div className="contact-layout">
            <div className="contact-details">
              ...
              <p className="contact-sub-text">
                Punya pertanyaan, masukan, atau butuh bantuan? Tim kami siap
                melayani Anda.
              </p>

              <div className="contact-info-block social-icons">
                <a
                  href="https://wa.me/081362533730"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="WhatsApp CookConnect"
                >
                  <i className="fab fa-whatsapp"></i>
                </a>
                <a
                  href="https://instagram.com/lemarilama.preloved"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Instagram CookConnect"
                >
                  <i className="fab fa-instagram"></i>
                </a>
                <a
                  href="https://www.tiktok.com/@puttripaadaang?is_from_webapp=1&sender_device=pc"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="TikTok CookConnect"
                >
        ...
        <section id="team" className="team-section container">
          ...
          <p>
            Website CookConnect ini dikembangkan sebagai tugas mata kuliah
            Pemrograman Web oleh tim kami.
          </p>
